...
Sistema **cliente-servidor** para la gestión y búsqueda de una **base de datos de canciones**.  
El sistema utiliza una **tabla hash** para indexar las canciones por nombre, permitiendo **búsquedas eficientes** y operaciones **CRUD** sobre los registros musicales.
...
- Operaciones soportadas:
  ...
  - ✏️ Escritura de nuevos registros  
...
- Proporciona estadísticas de distribución de datos  
- Realiza validación y limpieza de datos  
...
- 🧭 **Interfaz amigable:** Menús intuitivos y legibles  
...
**Solución:** Verificar que `tracks_features.csv` esté en el directorio correcto.
...
- Implementa **concurrencia básica** para múltiples clientes  
